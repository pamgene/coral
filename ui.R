                            ...
                            fluidRow(
                                   ...
                                   column(
                                          ...
                                          fluidRow(
                                                 width = 12,
                                                 box(
                                                        width = 12, title = "Upload Files", status = "danger", solidHeader = TRUE, collapsible = FALSE,
                                                        fileInput("txtInput1", " Choose .txt files from UKA PTK or STK", accept = c("text/plain", ".txt", "text/txt", "text/comma-separated-values"), multiple = TRUE),
                                          ...
                                          fluidRow(
                                                 ...
                                                 box(
                                                        ...
                                                        conditionalPanel(
                                                               ...
                                                               textInput(inputId = "quantvaluenamebranchcolor", label = "Legend Subtitle", value = "Kinase Statistic"),
                                                               fluidRow(
                                                                      width = 12,
                                                 ...
                                                 box(
                                                        ...
                                                        conditionalPanel(
                                                               ...
                                                               textInput(inputId = "quantvaluenamenodecolor", label = "Legend Subtitle", value = "Kinase Statistic"),
                                                               fluidRow(
                                                                      width = 12,
                                                 ...
                                                 box(
                                                        ...
                                                        conditionalPanel(
                                                               ...
                                                               conditionalPanel(
                                                                      ...
                                                                      textInput(inputId = "quantvaluenamenodesize", label = "Legend Subtitle", value = "Kinase Score"),
